...
function waitForInstagramChatInputAndSendButton() {
  ...
  if (instagramChatInput && sendButton) {
    ...
    // Retry after a delay
    setTimeout(waitForInstagramChatInputAndSendButton, 1000); // Wait for 1 second and try again
  }
}

// Start waiting for the elements
waitForInstagramChatInputAndSendButton();
