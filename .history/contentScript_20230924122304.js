...
if (window.location.hostname === "www.instagram.com") {
  ...
  const instagramChatInput = document.querySelector('.instagram-chat-input-selector');
  ...
  const instagramChatSendButton = document.querySelector('.instagram-chat-send-button-selector');
