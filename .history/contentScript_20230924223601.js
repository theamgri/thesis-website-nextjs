...
if (window.location.hostname === "www.instagram.com") {
  ...
  const instagramChatInput = document.querySelector('.x6s0dn4.x78zum5.x1gg8mnh.x1pi30zi.xlu9dua');

  // Identify the send button for Instagram chat
  const instagramChatSendButton = document.querySelector('.x1i10hfl');
