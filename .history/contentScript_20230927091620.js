...
// Function to set up Mutation Observer for Instagram chat input and button
function setupMutationObserver() {
  // Create a Mutation Observer to watch for changes in the DOM
  const observer = new MutationObserver(function(mutationsList) {
    for (let mutation of mutationsList) {
      if (mutation.type === 'childList') {
        // Check if the chat input and button have been added to the DOM
        const instagramChatInput = document.querySelector('.xat24cr.xdj266r.xdpxx8g span[data-lexical-text="true"]');
        ...
        if (instagramChatInput && sendButton) {
          // Elements found, remove the observer as they are now available
          observer.disconnect();
...
//   if (event.key === 'Enter') {
//     // Select the Instagram chat input field by its class
//     const instagramChatInput = document.querySelector('.xat24cr.xdj266r.xdpxx8g span[data-lexical-text="true"]');
    
//     // Select the Send button by its class
//     const sendButton = document.querySelector('.x1i10hfl.xjqpnuy.xa49m3k.xqeqjp1.x2hbi6w.xdl72j9.x2lah0s.xe8uvvx.xdj266r.xat24cr.x1mh8g0r.x2lwn1j.xeuugli.x1hl2dhg.xggy1nq.x1ja2u2z.x1t137rt.x1q0g3np.x1lku1pv.x1a2a7pz.x6s0dn4.xjyslct.x1ejq31n.xd10rxx.x1sy0etr.x17r0tee.x9f619.x1ypdohk.x1i0vuye.x1f6kntn.xwhw2v2.xl56j7k.x17ydfre.x2b8uid.xlyipyv.x87ps6o.x14atkfc.xcdnw81.xjbqb8w.xm3z3ea.x1x8b98j.x131883w.x16mih1h.x972fbf.xcfux6l.x1qhh985.xm0m39n.xt0psk2.xt7dq6l.xexx8yu.x4uap5.x18d9i69.xkhd6sd.x1n2onr6.x1n5bzlp.x173jzuc.x1yc6y37.xfs2ol5[role="button"][tabindex="0"]');
